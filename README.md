...
<h4 align="center">
  ...
  <span> • </span>
  <a href="https://github.com/wiredoor/wiredoor">Wiredoor Server</a>
  <span> • </span>
...
<div align="center">
  ...
  [![CI Status](https://github.com/wiredoor/wiredoor-cli/actions/workflows/release.yml/badge.svg)](https://github.com/wiredoor/wiredoor-cli/actions)
  [![Server Release](https://img.shields.io/github/v/release/wiredoor/wiredoor?label=Wiredoor)](https://github.com/wiredoor/wiredoor/releases)
  [![Docker](https://img.shields.io/docker/pulls/wiredoor/wiredoor-cli?label=Docker+Pulls&color=blue)](https://hub.docker.com/r/wiredoor/wiredoor-cli)
  [![License](https://img.shields.io/github/license/wiredoor/wiredoor-cli?label=Lic)](https://raw.githubusercontent.com/wiredoor/wiredoor-cli/main/LICENSE)
